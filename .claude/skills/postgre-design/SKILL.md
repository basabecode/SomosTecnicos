---
name: postgre-design
description: Design a PostgreSQL-specific schema following best practices. Covers data types, indexing, constraints, partitioning, RLS, and performance patterns. Use when designing a new database schema, reviewing an existing schema, choosing between data types, adding indexes, or optimizing PostgreSQL queries. Triggers on "diseñar schema", "design database", "PostgreSQL schema", "qué tipo de dato usar", "indexing strategy", "database design", or any PostgreSQL-specific question.
---
