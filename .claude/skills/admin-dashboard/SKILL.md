...
description: Extend and modify the admin dashboard, developer portal, and operations console. Use when adding new admin tabs, metrics, monitoring features, or internal tools. Triggers on "admin dashboard", "dashboard development", "analytics tab", "user management panel", "internal tooling", "agregar tab al admin", "métricas del dashboard", or any task involving admin panel features.
