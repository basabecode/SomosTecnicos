...
description: Interface design for dashboards, admin panels, SaaS apps, tools, settings pages, and interactive products. NOT for marketing design (landing pages, marketing sites, campaigns). Triggers on "diseñar interfaz", "design dashboard", "build admin panel", "create settings page", "UI for app", "interface design", "panel de control", "rediseñar la vista", or any task requiring a crafted product UI.
---
