    ...
    >
      ...
      <div className="flex items-center px-5 py-4 gap-3 bg-gray-50 mx-5 rounded-lg">
        <Avatar className="h-10 w-10">
          ...
          <AvatarFallback className="bg-[#991B1B] text-white text-sm font-semibold">
            {userInitials}
          </AvatarFallback>
        </Avatar>
      ...
      {showBackToHome && (
        <div className="mx-5 mt-4 mb-2 pb-3 border-b border-gray-200">
          <Link
            href="/"
            className="flex items-center gap-2 text-sm text-gray-600 hover:text-[#991B1B] transition-colors px-2 py-1 rounded-md hover:bg-gray-50"
          >
            <Home size={16} />
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                active
                  ? 'bg-gray-100 text-[#991B1B] font-semibold'
            ...
            >
              ...
              {item.badge && (
                <span className="flex items-center justify-center min-w-[20px] h-5 px-2 text-xs font-medium text-white bg-[#991B1B] rounded-full">
                  {item.badge}
                </span>
              )}
            </Link>
