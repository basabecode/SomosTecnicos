      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-8 w-full relative z-10">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left space-y-6 sm:space-y-8">
            ...
            {/* Botones de Acción */}
            <div
              className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-2 sm:pt-4 animate-fade-in-up"
              style={{ animationDelay: '400ms' }}
            >
              <Button
                onClick={scrollToForm}
                size="lg"
                className="bg-primary hover:bg-primary/90 active:scale-95 active:shadow-none text-white text-base sm:text-lg px-8 py-7 rounded-xl shadow-[0_0_20px_rgba(165,0,52,0.6)] lg:shadow-lg hover:shadow-2xl transition-all duration-150 hover:-translate-y-1 font-bold group relative overflow-hidden min-h-13"
              >
              ...
              <Button
                ...
                variant="outline"
                size="lg"
                className="bg-white/10 backdrop-blur-sm hover:bg-white/20 active:bg-white/30 active:scale-95 text-white border-2 border-white/30 hover:border-white/60 text-base sm:text-lg px-8 py-7 rounded-xl shadow-sm hover:shadow-lg transition-all duration-150 hover:-translate-y-1 font-semibold group min-h-13"
              >
                Hablar con IA
              </Button>
            </div>
