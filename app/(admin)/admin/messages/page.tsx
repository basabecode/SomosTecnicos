  ...
  return (
    <div className="space-y-6 h-[calc(100vh-100px)] flex flex-col">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-xl md:text-3xl font-bold text-gray-900">Buzón de Administración</h1>
          <p className="text-xs md:text-base text-gray-600 mt-1">Gestión de comunicaciones</p>
        </div>
        ...
        <DialogContent className="sm:max-w-125">
          ...
          <div className="grid gap-4 py-4">
            ...
            {newConvData.receiverType !== 'support' && (
              <div className="flex flex-col sm:grid sm:grid-cols-4 sm:items-center gap-2 sm:gap-4">
                <Label className="text-left sm:text-right">Destinatario</Label>
                <div className="sm:col-span-3">
