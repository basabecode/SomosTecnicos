/**
 * Layout para el área de Técnicos
 * Sidebar y navegación específica para técnicos
 */
      ...
      <div className="space-y-4 py-4">
        <div className="px-3 py-2">
          <div className="flex items-center space-x-2 mb-4">
            ...
            <h2 className="text-lg font-semibold">TecnoCity Técnico</h2>
          </div>
          ...
          <DropdownMenuContent className="w-56" align="end">
            <DropdownMenuLabel className="font-normal">
              <div className="flex flex-col space-y-1">
                ...
                <Badge
                  variant="secondary"
                  className="w-fit mt-1 bg-green-100 text-green-800"
                >
                  Técnico
                </Badge>
              </div>
