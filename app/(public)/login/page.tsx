  ...
  return (
    <div className="min-h-dvh flex flex-col md:flex-row relative">
      ...
      <div className="hidden md:flex flex-col w-5/12 xl:w-[42%] relative bg-[#2d1420] overflow-hidden">
        {/* Halos ambientales */}
        <div
          className="absolute top-0 right-0 w-80 h-80 bg-st-primary/10 rounded-full blur-3xl pointer-events-none"
          aria-hidden="true"
        />
        <div
          className="absolute bottom-1/4 left-0 w-60 h-60 bg-rose-950/30 rounded-full blur-2xl pointer-events-none"
          aria-hidden="true"
        />
        ...
        <div className="relative z-10 flex flex-col h-full px-10 xl:px-14 py-10">
          ...
          <div className="mb-10">
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-xs">
              Gestiona servicios, coordina técnicos y da seguimiento a cada
          ...
          <div className="flex-1 flex flex-col min-h-0">
            ...
            */}
            <div
              className="
                relative
                flex-1 min-h-0 lg:min-h-95 xl:min-h-105
                max-h-135 xl:max-h-150
              ...
              <>
                ...
                {forgotSuccess ? (
                  <div className="space-y-4">
                    <Alert className="bg-green-50 border-green-200 text-green-800 rounded-lg py-3">
                      <CheckCircle2 className="h-4 w-4 shrink-0" />
                      <AlertDescription className="ml-2 text-sm font-medium">
                        Si el correo <strong>{forgotEmail}</strong> está
                        registrado, recibirás instrucciones en breve.
                      </AlertDescription>
                    </Alert>
                    <Button
                      type="button"
                      ...
                      className="w-full h-11 bg-st-primary hover:bg-st-primary-hover text-white font-semibold text-sm rounded-lg transition-all"
                    >
                  ...
                  >
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        <Mail className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 pointer-events-none text-gray-400" />
                        <Input
                          id="forgot-email"
                          type="email"
                          ...
                          className="h-11 pl-10 text-sm rounded-lg border border-gray-200 transition-all focus-visible:border-st-primary focus-visible:ring-st-primary/15"
                        />
                      </div>
                    </div>
                    ...
                    <Button
                      type="submit"
                      disabled={forgotLoading}
                      className="w-full h-11 bg-st-primary hover:bg-st-primary-hover text-white font-semibold text-sm rounded-lg transition-all active:scale-[0.98]"
                    >
                      {forgotLoading ? (
                        <>
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      <Lock
                        className={`absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 pointer-events-none ${passwordError ? 'text-red-400' : 'text-gray-400'}`}
                      />
                      <Input
                        id="password"
